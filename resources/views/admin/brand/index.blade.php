                ...
                <div class="card-footer">
                    <form action="{{ route('brand.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="brandName" class="form-control" placeholder="Brand Name">
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="slug" id="brandSlug" class="form-control" placeholder="Brand Slug">
                            @error('slug')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <img src="{{ asset('default.webp') }}" width="120" class="mb-2" alt="" id="brandImagePrv">
